...
\* BEGIN TRANSLATION (chksum(pcal) = "10828f5c" /\ chksum(tla) = "a1715f83")
...
Init == (* Global variables *)
        ...
        /\ acc = [p \in people |-> 5]
        (* Process Wire *)
        /\ sender = [self \in 1..1 |-> "alice"]
        /\ receiver = [self \in 1..1 |-> "bob"]
        /\ amount \in [1..1 -> 1..acc[sender[CHOOSE self \in  1..1 : TRUE]]]
...
\* Last modified Wed Sep 13 15:39:20 CST 2023 by linshizhi
