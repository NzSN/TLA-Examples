...
\* BEGIN TRANSLATION (chksum(pcal) = "14ca0771" /\ chksum(tla) = "9979f214")
...
Init == (* Global variables *)
        ...
        /\ acc = [p \in people |-> 5]
        (* Process Wire *)
        /\ sender = [self \in 1..3 |-> "alice"]
        /\ receiver = [self \in 1..3 |-> "bob"]
        /\ amount \in [1..3 -> 1..acc[sender[CHOOSE self \in  1..3 : TRUE]]]
...
\* Last modified Wed Sep 13 16:17:40 CST 2023 by linshizhi
